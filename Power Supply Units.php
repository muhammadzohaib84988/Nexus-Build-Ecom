...
$imageDirectory = 'C:/xampp/New folder/htdocs/Yaseen Project/imgs/Power Supplies';
...
<body>
    ...
    <div class="container">
        <h1>Custom Computer <span>Power Supplies</span></h1>

        <div class="product-grid">
            <?php foreach ($imageFiles as $imageFile): ?>
                <div class="product-card">
                    <img src="imgs/Power Supplies/<?php echo $imageFile; ?>" alt="Product Image">
                    <h3 class="card-title">Power Supplies Model</h3>
                    <p>Custom Computer, Power Supplies | NEW</p>
