...
$imageDirectory = 'C:/xampp/New folder/htdocs/Yaseen Project/imgs/RAM';
...
<body>
    ...
    <div class="container">
        <h1>Custom Computer <span>RAM</span></h1>

        <div class="product-grid">
            <?php foreach ($imageFiles as $imageFile): ?>
                <div class="product-card">
                    <img src="imgs/RAM/<?php echo $imageFile; ?>" alt="Product Image">
                    <h3 class="card-title">RAM Model</h3>
                    <p>Custom Computer,RAM | NEW</p>
