...
$imageDirectory = 'C:/xampp/New folder/htdocs/Yaseen Project/imgs/motherboard';
...
<head>
    ...
    <title>Custom Computer motherboard</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        <h1>Custom Computer <span>Motherboard</span></h1>

        <div class="product-grid">
            <?php foreach ($imageFiles as $imageFile): ?>
                <div class="product-card">
                    <img src="imgs/motherboard/<?php echo $imageFile; ?>" alt="Product Image">
                    <h3 class="card-title">motherboard Model</h3>
                    <p>Custom Computer, motherboard | NEW</p>
