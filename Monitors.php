...
$imageDirectory = 'C:/xampp/New folder/htdocs/Yaseen Project/imgs/Monitors';
...
<body>
    ...
    <div class="container">
        <h1>Custom Computer <span>Monitors</span></h1>

        <div class="product-grid">
            <?php foreach ($imageFiles as $imageFile): ?>
                <div class="product-card">
                    <img src="imgs/Monitors/<?php echo $imageFile; ?>" alt="Product Image">
                    <h3 class="card-title">Monitors Model</h3>
                    <p>Custom Computer, CMonitors | NEW</p>
