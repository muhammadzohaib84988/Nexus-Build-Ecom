        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="normal__breadcrumb__text">
                        <h2>Contact Us</h2>
                        <p>Welcome to the official Gamerz Website</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="contact__info__text">
                        ...
                        <ul>
                            <?php if ($contact): ?>
                            <li><strong>Website Name: Gamerz.com</strong> <?php ($contact['website_name']); ?>
                            </li>
                            <li><strong>Email: Yaseen@gmail.com</strong> <a
                                    href="mailto:<?php ($contact['email']); ?>"><?php ($contact['email']); ?></a>
                            </li>
                            <li><strong>Phone:</strong> <?php ($contact['phone']); ?></li>
                            <li><strong>Address:</strong> <?php ($contact['address']); ?></li>
