...
$imageDirectory = 'C:/xampp/New folder/htdocs/Yaseen Project/imgs/Mouse';
...
<head>
    ...
    <title>Custom Computer Mouse</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        <h1>Custom Computer <span>Mouse</span></h1>

        <div class="product-grid">
            <?php foreach ($imageFiles as $imageFile): ?>
                <div class="product-card">
                    <img src="imgs/Mouse/<?php echo $imageFile; ?>" alt="Product Image">
                    <h3 class="card-title">Peripherals</h3>
                    <p>Custom Computer, Mouse | NEW</p>
