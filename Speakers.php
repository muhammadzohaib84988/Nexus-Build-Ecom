...
$imageDirectory = 'C:/xampp/New folder/htdocs/Yaseen Project/imgs/Speakers';
...
<head>
    ...
    <title>Custom Computer Speakers</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        <h1>Custom Computer <span>Speakers</span></h1>

        <div class="product-grid">
            <?php foreach ($imageFiles as $imageFile): ?>
                <div class="product-card">
                    <img src="imgs/Speakers/<?php echo $imageFile; ?>" alt="Product Image">
                    <h3 class="card-title">Speakers Model</h3>
                    <p>Custom Computer, Speakers | NEW</p>
