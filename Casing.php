...
$imageDirectory = 'C:/xampp/New folder/htdocs/Yaseen Project/imgs/Casing';
...
<body>
    ...
    <div class="container">
        <h1>Custom Computer <span>Casing</span></h1>

        <div class="product-grid">
            <?php foreach ($imageFiles as $imageFile): ?>
                <div class="product-card">
                    <img src="imgs/Casing/<?php echo $imageFile; ?>" alt="Product Image">
                    <h3 class="card-title">Casing Model</h3>
                    <p>Custom Computer, Casing | NEW</p>
