...
$imageDirectory = 'C:/xampp/New folder/htdocs/Yaseen Project/imgs/CPU Coolers';
...
<body>
    ...
    <div class="container">
        <h1>Custom Computer <span>CPU Coolers</span></h1>

        <div class="product-grid">
            <?php foreach ($imageFiles as $imageFile): ?>
                <div class="product-card">
                    <img src="imgs/CPU Coolers/<?php echo $imageFile; ?>" alt="Product Image">
                    <h3 class="card-title">Casing Model</h3>
                    <p>Custom Computer, CPU Coolers | NEW</p>
