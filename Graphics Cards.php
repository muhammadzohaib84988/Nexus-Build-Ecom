...
$imageDirectory = 'C:/xampp/New folder/htdocs/Yaseen Project/imgs/Graphics Card';
...
<head>
    ...
    <title>Custom Computer Graphics Card</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        <h1>Custom Computer <span>Graphics Card</span></h1>

        <div class="product-grid">
            <?php foreach ($imageFiles as $imageFile): ?>
                <div class="product-card">
                    <img src="imgs/Graphics Card/<?php echo $imageFile; ?>" alt="Product Image">
                    <h3 class="card-title">Graphics Card Model</h3>
                    <p>Custom Computer, Graphics Card | NEW</p>
