...
$imageDirectory = 'C:/xampp/New folder/htdocs/Yaseen Project/imgs/Storage';
...
<body>
    ...
    <div class="container">
        <h1>Custom Computer <span>Storage</span></h1>

        <div class="product-grid">
            <?php foreach ($imageFiles as $imageFile): ?>
                <div class="product-card">
                    <img src="imgs/Storage/<?php echo $imageFile; ?>" alt="Product Image">
                    <h3 class="card-title">Storage Model</h3>
                    <p>Custom Computer, Storage | NEW</p>
